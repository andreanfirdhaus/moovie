...
export default function DetailPage() {
    ...
    return (
        <main>
            {/* test large device */}
            <section className='hidden md:block lg:h-screen'>
            ...
            <section className='block md:hidden'>
                    ...
                    <div className='relative h-full w-full'>
                        ...
                        <div className='absolute bottom-8 flex items-center mx-auto gap-10 px-4 sm:px-6 lg:px-8'>
                            <LazyLoadImage
                                ...
                                src={detail.poster_path ? TMDB_IMG_300 + detail.poster_path : FALLBACK_POSTER}
                                alt={`${getMovieTitle(detail)} poster`}
                                className='bg-contain bg-center rounded-md sm:rounded-xl w-full h-52 shadow-[0_0_30px_rgba(255,255,255,0.3)]'
                                delayTime={300}
                            />
                        </div>
                    </div>
                ...
                <div className='pt-8 px-4 sm:px-6 lg:px-8'>
                    ...
                    <div className='flex items-center gap-2 my-3'>
                        ...
                        <div className='flex flex-col gap-0.5'>
                            <span className='font-medium text-[15px] text-white max-w-xs'>
                                {getGenresText(detail.genres)}
            ...
            {credits?.length && (
                <section className='max-w-7xl mx-auto pt-12 pb-8'>
                    <header className='px-4 sm:px-6 lg:px-8 mb-2 sm:mb-6'>
                        <h1 className='text-left text-2xl font-semibold text-zinc-100'>Series Cast</h1>
                    </header>

                    <Swiper {...moviesSwiperParams} modules={[Autoplay]} className='mySwiper px-4 sm:px-6 lg:px-8 py-4'>
                        {credits.map((credits) => (
