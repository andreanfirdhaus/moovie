...
import { faDiscord, faReact } from "@fortawesome/free-brands-svg-icons";

function Footer() {
    return (
        <div>
            <div className="bg-blackLight dark:bg-blackDark">
                <footer className="max-w-7xl mx-auto py-6 sm:py-0 px-4 sm:px-6 lg:px-8">
                    <div className="container mx-auto space-y-6">
                        <div className="px-12 pt-12 space-y-8 md:flex md:justify-between md:px-6 md:space-y-0">
                            <div className="flex flex-col my-6 space-y-4 md:m-0">
                                ...
                                <p className="text-center md:max-w-sm md:text-left text-base font-normal tracking-wide text-whiteLight dark:text-white">
                                    A simple website that provides brief
                                    information about a movie by genre. Find the
                                    movie you{" "}
                                    <a
                        ...
                        <div className="flex flex-col-reverse items-center justify-between p-4 text-center sm:flex-row text-whiteLight dark:text-white">
